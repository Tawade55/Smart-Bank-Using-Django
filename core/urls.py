...
from core import transaction,payment_request,credit_card
...
urlpatterns = [
    ...
    path("delete-card/<card_id>/",credit_card.delete_credit_card,name="delete-card"),
    path("withdraw-card/<card_id>/",credit_card.withdraw_fund,name="withdraw-card"),
